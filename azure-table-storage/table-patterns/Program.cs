...
namespace AzureTableStorage.Patterns
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("Index entities pattern");
        ...
        static async Task CreateIndexEntitiesPatternDemo()
        {
            ...
            await table.ExecuteBatchAsync(batchOperation1);
            await table.ExecuteBatchAsync(batchOperation2);
            await table.ExecuteBatchAsync(batchOperation3);
            ...
            var result1 = await table.ExecuteQuerySegmentedAsync(rangeQuery1, null);
            string[] movieTitles = {};
            ...
            var movies = await table.ExecuteQuerySegmentedAsync(query, null);
        ...
        static void ReadConfiguration()
        {
            ...
            Debug.WriteLine($"Read param: [Connection String] - [Value]: {connectionString}");
        }
    }
}
